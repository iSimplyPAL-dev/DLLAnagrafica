...
Namespace DLL
    Public Class AnagUtility
        Dim _Const As New Costanti()
        Private Log As ILog = LogManager.GetLogger(GetType(AnagUtility))

        Public Function InizializzaCmd(TypeDB As String, ByVal StringConnection As String) As Object
            Log.Debug("AnagraficaDLL::Utility::InizializzaCmd::apertura della connessione al DB")

            Try
                If TypeDB = "MySQL" Then
                    Dim cmdMyCommand As New MySql.Data.MySqlClient.MySqlCommand
                    cmdMyCommand.Connection = New MySql.Data.MySqlClient.MySqlConnection(StringConnection)
            ...
            End Try
        End Function
        Public Function InizializzaCmdSQL(ByVal StringConnection As String) As SqlCommand
            Log.Debug("AnagraficaDLL::Utility::InizializzaCmd::apertura della connessione al DB")
            Dim cmdMyCommand As New SqlCommand
        ...
        Public Function GetNewId(ByRef strNomeTabella As String, ByVal cmdMyCommand As SqlCommand, ByVal StringConnection As String) As Long
            Dim strSql As String
            Dim lngMaxId As Long
            Dim intRetVal As Integer
            Dim objCONST As New Costanti
            ...
            Try
                ...
                Try
                    ...
                    'Log.Debug("AnagraficaDLL::Utility::GetNewId::" + strSql)
        ...
        '======================================================================================
        'Public Shared Function GetValParamCmd(ByVal MyCMD As SqlClient.SqlCommand) As String
