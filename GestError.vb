...
Namespace DLL
  Public Class GestError
	...
	End Function
        ...
        Public Sub SendEmailError(ByVal ex As Exception, ByVal mailTo As String, ByVal mailSubject As String, ByVal mailFrom As String, ByVal NameSmtpServer As String)

            Dim mail As New MailMessage()

            Dim ErrorMessage As String = "Descrizione Errore : " & ex.Message & ex.StackTrace
            mail.To = mailTo
