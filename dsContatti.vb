...
Namespace DLL
    ...
    Public Class dsContatti
        ...
        Public Class CONTATTIDataTable
            ...
            '*** 20140515 - invio mail ***
            Private columnDataValiditaInvioMAIL As DataColumn
            '*** ***
            Private columnCOD_CONTRIBUENTE As DataColumn

            Private columnIDDATAANAGRAFICA As DataColumn
            Private columnDescrContatto As DataColumn
            ...
            End Property
            '*** 20140515 - invio mail ***
            Friend ReadOnly Property DataValiditaInvioMAILColumn() As DataColumn
                Get
                    Return Me.columnDataValiditaInvioMAIL
                End Get
            End Property
            '*** ***
            ...
            Friend ReadOnly Property IDDATAANAGRAFICAColumn() As DataColumn
                ...
                End Get
            End Property
            Friend ReadOnly Property DescrContattoColumn() As DataColumn
                Get
                    Return Me.columnDescrContatto
                End Get
            End Property
            ...
            'End Function
            Public Overloads Function AddCONTATTIRow(ByVal TipoRiferimento As Integer, ByVal DatiRiferimento As String, ByVal DataValiditaInvioMAIL As String, ByVal COD_CONTRIBUENTE As Integer, ByVal IDDATAANAGRAFICA As Integer) As CONTATTIRow
                Dim rowCONTATTIRow As CONTATTIRow = CType(Me.NewRow, CONTATTIRow)
                rowCONTATTIRow.ItemArray = New Object() {Nothing, TipoRiferimento, DatiRiferimento, DataValiditaInvioMAIL, COD_CONTRIBUENTE, IDDATAANAGRAFICA}
                Me.Rows.Add(rowCONTATTIRow)
                Return rowCONTATTIRow
            End Function
            '*** ***
            ...
            Friend Sub InitVars()
                ...
                '*** 20140515 - invio mail ***
                Me.columnDataValiditaInvioMAIL = Me.Columns("DataValiditaInvioMAIL")
                '*** **
                Me.columnCOD_CONTRIBUENTE = Me.Columns("COD_CONTRIBUENTE")
                Me.columnIDDATAANAGRAFICA = Me.Columns("IDDATAANAGRAFICA")
                Me.columnDescrContatto = Me.Columns("DescrContatto")
            End Sub
            ...
            Private Sub InitClass()
                ...
                '*** 20140515 - invio mail ***
                Me.columnDataValiditaInvioMAIL = New DataColumn("DataValiditaInvioMAIL", GetType(System.String), Nothing, System.Data.MappingType.Element)
                Me.Columns.Add(Me.columnDataValiditaInvioMAIL)
                '*** ***
                ...
                Me.columnDescrContatto = New DataColumn("DescrContatto", GetType(System.String), Nothing, System.Data.MappingType.Element)
                Me.Columns.Add(Me.columnDescrContatto)
            End Sub
        ...
        Public Class CONTATTIRow
            ...
            Public Property DataValiditaInvioMAIL() As String
                Get
                    Try
                        Return CType(Me(Me.tableCONTATTI.DataValiditaInvioMAILColumn), String)
                    Catch e As InvalidCastException
                        Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                    End Try
                End Get
                Set(ByVal Value As String)
                    Me(Me.tableCONTATTI.DataValiditaInvioMAILColumn) = Value
                End Set
            End Property
            '*** ***
            ...
            Public Property IDDATAANAGRAFICA() As Integer
                ...
                End Set
            End Property
            Public Property DescrContatto() As String
                Get
                    Try
                        Return CType(Me(Me.tableCONTATTI.DescrContattoColumn), Integer)
                    Catch e As InvalidCastException
                        Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                    End Try
                End Get
                Set(ByVal Value As String)
                    Me(Me.tableCONTATTI.DescrContattoColumn) = Value
                End Set
            End Property
            ...
            End Sub
            '*** 20140515 - invio mail ***
            Public Sub SetDataValiditaInvioMAILNull()
                Me(Me.tableCONTATTI.DataValiditaInvioMAILColumn) = System.Convert.DBNull
            End Sub
            '*** ***
            ...
            End Sub
            Public Function DescrContattoNull() As Boolean
                Return Me.IsNull(Me.tableCONTATTI.DescrContattoColumn)
            End Function
            Public Sub SetDescrContattoNull()
                Me(Me.tableCONTATTI.DescrContattoColumn) = System.Convert.DBNull
            End Sub
        End Class
